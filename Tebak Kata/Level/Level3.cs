...
namespace Tebak_Kata.Level
{
    public partial class Level3 : Form
    {
        ...
        public Level3()
        {
            ...
            // Your query,
            string query = "SELECT id_quiz, level, kosakata, kategori, jawaban, hint FROM `quiz` q, `kategori_quiz` k, `jawaban_quiz` j , `hint` h where q.id_kategori = k.id_kategori and q.id_jawaban = j.id_jawaban and q.id_hint = h.id_hint and id_quiz=3;";
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                IncorrectAns3 ia = new IncorrectAns3();
                ia.Show();
            }
        }
