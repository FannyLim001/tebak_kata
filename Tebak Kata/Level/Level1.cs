...
namespace Tebak_Kata.Level
{
    public partial class Level1 : Form
    {
        ...
        public Level1()
        {
            ...
            // Your query,
            string query = "SELECT id_quiz, level, kosakata, kategori, jawaban, hint FROM `quiz` q, `kategori_quiz` k, `jawaban_quiz` j , `hint` h where q.id_kategori = k.id_kategori and q.id_jawaban = j.id_jawaban and q.id_hint = h.id_hint and id_quiz=1;";
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                CorrectAns ca = new CorrectAns();
                ca.Show();
            } else
            {
                timer1.Stop();
                IncorrectAns ia = new IncorrectAns();
                ia.Show();
            }
        }
